...
// SetDTR sets the DTR on the COM Port
func (p *Port) SetDTR() error {
	// Set DTR - code 5 on https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-escapecommfunction
	if err := escapeCommFunction(p.fd, 5); err != nil {
		return err
	}
	return nil
}

// ClearDTR clears the DTR on the COM Port
func (p *Port) ClearDTR() error {
	// Set DTR - code 6 on https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-escapecommfunction
	if err := escapeCommFunction(p.fd, 6); err != nil {
		return err
	}
	return nil
}
...
func escapeCommFunction(h syscall.Handle, dwfunc uint32) error {
	// From https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-escapecommfunction
